...
export const blogPosts = [
  {
    ...
    tableData: [
      { keyword: "future of real estate in pakistan 2025", count: "3" },
      { keyword: "property prices in 2025 in pakistan", count: "2" },
      { keyword: "real estate future in pakistan", count: "2" },
      { keyword: "pakistan in 2025 future predictions", count: "2" },
      { keyword: "pakistan real estate market", count: "2" },
      { keyword: "will property prices go up in pakistan", count: "1" },
      { keyword: "is it good to invest in real estate in pakistan 2025", count: "1" },
      { keyword: "what is the forecast for property in pakistan 2025", count: "1" },
      { keyword: "what is the future of property investment in pakistan", count: "1" },
      { keyword: "best cities to invest in real estate pakistan 2025", count: "1" },
      { keyword: "Economic Stability & Policy Support", count: "2" },
      { keyword: "Commercial Property Expansion", count: "2" },
      { keyword: "Reduction in Interest Rates", count: "2" },
      { keyword: "Gated Communities", count: "2" },
      { keyword: "Regulatory Concerns & Reforms", count: "2" },
      { keyword: "Technological Advancements in Real Estate", count: "2" },
      { keyword: "Development of Smart Cities", count: "2" },
      { keyword: "Mixed Used Developments", count: "2" },
      { keyword: "Growth in Rental Market", count: "2" },
      { keyword: "Urbanization Accelerates Market Growth", count: "2" },
      { keyword: "Growth in Property Prices", count: "2" },
      { keyword: "Digital Infrastructure Investments", count: "2" },
      { keyword: "High-rise Buildings", count: "2" },
      { keyword: "Diversification of Investment Options", count: "2" },
      { keyword: "Rising Interest in Commercial Real Estate", count: "2" },
      { keyword: "Sustainable and Green Real Estate Development", count: "2" },
      { keyword: "Increased Focus on Affordable Housing", count: "2" },
    ],
    faq: [
      {
